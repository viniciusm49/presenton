  ...
  >
      ...
      >
        ...
        >
          <div className="p-6 pb-4 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-semibold text-[#191919] mb-2">Excluir Tema?</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
              Você está prestes a excluir <span className="font-medium text-gray-700">"{theme.name}"</span>. Esta ação não pode ser desfeita.
            </p>
          </div>
    ...
    <div className='relative h-[250px] flex justify-center items-center '>
      ...
      <div className=" absolute top-0 left-0 flex items-center justify-between gap-2  z-[2] p-2">
        ...
        {theme.company_name && <ToolTip content='EMPRESA'>
