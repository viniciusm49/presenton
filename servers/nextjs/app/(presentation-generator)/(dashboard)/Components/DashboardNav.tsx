            ...
            <div className="flex xl:flex-row flex-col gap-6 xl:gap-0 items-center justify-between">
                ...
                <div className="flex  gap-2.5 max-sm:w-full max-md:justify-center max-sm:flex-wrap">
                    ...
                    {activeTab !== "playground" && activeTab !== "theme" && <Link
                        ...
                        aria-label="Criar nova apresentação"
                        style={{
                            borderRadius: "48px",
                    ...
                    >
                        ...
                        <span className="hidden md:inline">Nova apresentação</span>
                    ...
                    {activeTab === "theme" &&
                        <Link
                            ...
                            aria-label="Criar novos temas"
                            style={{
                                borderRadius: "48px",
                                background: "linear-gradient(270deg, #D5CAFC 2.4%, #E3D2EB 27.88%, #F4DCD3 69.23%, #FDE4C2 100%)",
                            }}
                        >
                            <span className="hidden md:inline">Novos Temas</span>
                            <span className="md:hidden">Novo</span>
                            <ChevronRight className="w-4 h-4" />
                        </Link>
                    }
