    ...
    <div className="w-full space-y-6">
      <div className="bg-[#F9F8F8] p-7 rounded-[20px]">
        <h4 className="text-sm font-semibold text-[#191919] mb-1">
          Análise de uso e telemetria
        </h4>
        <p className="text-xs text-[#6B7280] mb-6 leading-relaxed max-w-lg">
          Compartilhe dados de uso anônimos para nos ajudar a melhorar o Presenton. Nenhuma informação pessoal ou conteúdo de apresentação é coletado.
        </p>
        ...
        <div className="flex items-center justify-between gap-4 rounded-[10px] bg-white border border-[#EDEEEF] p-4">
          <div>
            ...
            <p className="text-xs text-[#9CA3AF] mt-0.5">
              {trackingEnabled
                ? "Dados anônimos de uso estão sendo compartilhados."
                : "Dados anônimos de uso não estão sendo compartilhados."}
            </p>
          </div>
