          ...
          <div className="mb-4 flex items-center justify-between bg-[#EDE9FE] border border-[#C4B5FD] rounded-xl px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-[#5B21B6]">
                Exibindo pré-visualização gerada por IA
              </span>
            </div>
            {onClearPreview && (
              <Button
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-base font-semibold text-[#991B1B] mb-1">
              {isImageTooLarge ? "Imagem muito grande" : "Falha na conversão"}
            </h4>
            <p className="text-sm text-[#B91C1C] mb-4">
              {isImageTooLarge
                ? "A imagem deste slide excede o limite de 5MB. Tente usar um arquivo PPTX com resolução menor ou compactar as imagens."
                : slide.error
              }
            </p>
            <button
