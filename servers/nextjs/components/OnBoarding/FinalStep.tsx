    ...
    return (
        <div className='fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <h1 className='text-black text-[30px] font-normal font-unbounded py-2.5'>Bem-vindo a bordo!</h1>
                <p className='text-[#000000CC] text-xl font-normal font-syne'>Tudo pronto. Vamos criar sua primeira apresentação.</p>

                {trackingEnabled !== null && (
                    <div className='flex items-center gap-3 mt-8 px-5 py-3.5 rounded-[10px] border border-[#EDEEEF] bg-white'>
                        <div>
                            <p className='text-sm font-medium text-[#191919] font-syne'>Métricas de uso</p>
                            <p className='text-[11px] text-[#9CA3AF] font-syne leading-tight mt-0.5'>Ajude a melhorar o Presenton compartilhando dados anônimos de uso.</p>
                        </div>
                        <Switch
                ...
                <button onClick={handleGoToUpload} className='bg-[#7C51F8] px-[23px] mt-8 py-[15px]  rounded-[70px] text-white text-lg font-syne font-semibold'>Minha Primeira Apresentação 🚀</button>
                <button onClick={fireRealisticConfetti} className='mt-3 flex items-center gap-1.5 text-sm text-[#7A5AF8] font-syne font-medium hover:underline'>
                    <PartyPopper className='w-4 h-4' /> Comemorar novamente!
                </button>
            </div>
            <button onClick={handleGoToDashboard} className='absolute uppercase bottom-20 text-[#7A5AF8] flex items-center gap-2 right-10  text-xs font-normal font-syne'>Ir para o seu painel <ArrowRight className='w-4 h-4 text-[#7A5AF8]' /></button>
        </div>
    )
}
