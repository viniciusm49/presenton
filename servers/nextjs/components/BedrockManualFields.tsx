    ...
    <div className="mt-3 w-full min-w-0 max-w-full space-y-4">
      <div className="space-y-1.5">
        ...
        <input
          ...
          placeholder="ex: us.anthropic.claude-3-5-haiku-20241022-v1:0"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="Use esta OU as chaves de acesso AWS abaixo"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="Use junto com a AWS Secret Access Key"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="Use junto com o AWS Access Key ID"
        />
      </div>

      <p className="text-xs text-gray-500">
        Autenticação: defina a chave de API do Bedrock ou o ID da chave de acesso AWS + chave secreta.
      </p>
